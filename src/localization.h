...
enum Texts
{
    ...
    TXT_Action_CHOOSE_COLOR_BUTTON_1,
    TXT_Action_CHOOSE_COLOR_BUTTON_2,
    TXT_Action_CHOOSE_COLOR_BUTTON_3,
    TXT_Action_CHOOSE_COLOR_BUTTON_4,
    TXT_Action_CHOOSE_COLOR_BUTTON_5,
